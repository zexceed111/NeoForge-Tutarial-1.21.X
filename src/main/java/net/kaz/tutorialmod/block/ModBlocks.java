package net.kaz.tutorialmod.block;

import net.kaz.tutorialmod.TutorialMod;
import net.kaz.tutorialmod.block.custom.MagicBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> MAGIC_BLICK = registerBlock("magic_block",
